...
def start_parallel_hand_sign_recognition(model_left_1, model_right_1, model_left_2, model_right_2):
    ...
    thread_1 = threading.Thread(target=hand_sign_recognition, args=(model_left_1, model_right_1, 0))  # PC Camera
    thread_2 = threading.Thread(target=hand_sign_recognition, args=(model_left_2, model_right_2, 1))  # USB Webcam
